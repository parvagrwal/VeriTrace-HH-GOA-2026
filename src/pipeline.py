...
def run_pipeline(
    ...
    # full pipeline: face detect -> reverse search -> canonical record
    ...
    # Use cropped face if requested, else source image
    ...
    full_saved_record = {
        **record_payload,
        ...
        "search_metadata": {
            ...
            "snippet": top_match["snippet"],
            "is_social": top_match["is_social"],
        },
    }
